...
const ko: Dictionary = {
  ...
  securitySection: {
    ...
    items: [
      ...
      { title: '서버 없음', body: '침해하거나 소환하거나 팔 백엔드가 없습니다. 우리는 아무것도 보관하지 않습니다.' },
      {
        title: '제3자 분석 없음',
  ...
  support: {
    title: '지원',
    intro: '아래에서 자주 묻는 질문을 확인하세요. 도움이 더 필요하신가요? 메시지를 보내주시면 이메일로 답변드립니다.',
    contactTitle: '문의하기',
    contactIntro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          '아니요. 참고용 추정치일 뿐이며 피임이나 의료 결정에 의존해서는 안 됩니다.',
      },
      {
